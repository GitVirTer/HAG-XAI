...
sel_method = 'fullgradcampp'  # gradcam, gradcampp, fullgradcam, fullgradcampp, DRISE, saveRawGradAct, saveRawAllAct; Note: the 'fullgradcam' is the same as the 'ODAM' method.
sel_nms = 'NMS'
sel_prob = 'class'
sel_norm = 'norm'
